          ...
          {menuItems.map((item) => (
            <Link
              ...
              style={{
                ...
                alignItems: 'center',
                padding: '12px 20px',
                color: location.pathname === item.path ? '#09c398' : '#fff',
                textDecoration: 'none',
                background: location.pathname === item.path ? 'rgba(9, 195, 152, 0.1)' : 'transparent',
                borderRight: location.pathname === item.path ? '3px solid #09c398' : 'none'
              }}
            >
