    ...
    <div>
      <div style={{ marginBottom: '20px' }}>
        ...
        <h2 style={{ fontSize: '32px', margin: '10px 0' }}>
          {showBalance 
            ? `₦${stats?.total_investment_value.toLocaleString('en-NG', { minimumFractionDigits: 2 })}` 
            : '₦••••••'}
          <span 
      ...
      {stats && (
        <AdminStats
          ...
          realEstateCount={stats.real_estate_count}
          agricultureCount={stats.agriculture_count}
        />
      )}
