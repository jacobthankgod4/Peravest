...
const Home: React.FC = () => {
  ...
  return (
    <Layout title="PeraVest - Real Estate Investment Platform">
          ...
          <div className="row align-items-center">
            <div className="col-lg-6">
              <div style={{ marginBottom: '30px' }}>
                <h2 style={{ fontSize: '40px', fontWeight: 900, color: '#0e2e50', marginBottom: '15px' }}>Peravest unlocks professional real estate investments for everyone</h2>
                ...
                <Link to="/listings" style={{ display: 'inline-block', padding: '12px 32px', background: 'linear-gradient(135deg, #09c398 0%, #06a876 100%)', color: '#fff', textDecoration: 'none', borderRadius: '10px', fontWeight: 900, fontSize: '14px', transition: 'all 0.3s' }} onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-2px)'; e.currentTarget.style.boxShadow = '0 10px 30px rgba(9, 195, 152, 0.3)'; }} onMouseLeave={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = 'none'; }}>See our crowdfunding offers <i className="far fa-arrow-right" style={{ marginLeft: '8px' }}></i></Link>
              </div>
            </div>
            <div className="col-lg-6">
              <div style={{ marginBottom: '30px' }}>
                <h2 style={{ fontSize: '40px', fontWeight: 900, color: '#0e2e50', marginBottom: '15px' }}>A great investment shouldn't keep you up at night</h2>
                ...
                <Link to="/register" style={{ display: 'inline-block', padding: '12px 32px', background: 'linear-gradient(135deg, #09c398 0%, #06a876 100%)', color: '#fff', textDecoration: 'none', borderRadius: '10px', fontWeight: 900, fontSize: '14px', transition: 'all 0.3s' }} onMouseEnter={(e) => { e.currentTarget.style.transform = 'translateY(-2px)'; e.currentTarget.style.boxShadow = '0 10px 30px rgba(9, 195, 152, 0.3)'; }} onMouseLeave={(e) => { e.currentTarget.style.transform = 'translateY(0)'; e.currentTarget.style.boxShadow = 'none'; }}>Sign Up <i className="far fa-arrow-right" style={{ marginLeft: '8px' }}></i></Link>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="savings-features-area" style={{ background: '#0e2e50', padding: '0 0 80px 0' }}>
      ...
      <div style={{ background: '#fff', padding: '80px 20px' }}>
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '60px' }}>
            <span style={{ color: '#09c398', fontSize: '18px', fontWeight: 900, textTransform: 'uppercase', letterSpacing: '1px' }}>Your way to your investment</span>
            <h2 style={{ fontSize: '56px', fontWeight: 900, color: '#0e2e50', marginBottom: '15px', marginTop: '10px' }}>How it works</h2>
          </div>
          <div className="row">
          ...
          <div className="row">
            <div className="col-lg-6 mx-auto wow fadeInDown" data-wow-duration="1s" data-wow-delay=".25s">
              <div className="site-heading text-center">
                <span className="site-title-tagline" style={{ fontWeight: 900, fontSize: '18px', color: '#fff' }}>Our Blog</span>
                <h2 className="site-title" style={{ fontWeight: 900, color: '#fff', fontSize: '56px' }}>Our Latest News & Blog</h2>
              </div>
            </div>
          </div>
          <div className="row">
