  ...
  return (
    <Layout title="PeraVest - Real Estate Investment Platform">
      ...
      <div style={{ background: '#fff', padding: '80px 20px' }}>
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '60px' }}>
            <span style={{ color: '#09c398', fontSize: '20px', fontWeight: 900, textTransform: 'uppercase', letterSpacing: '1px' }}>Your way to your investment</span>
            <h2 style={{ fontSize: '64px', fontWeight: 900, color: '#0e2e50', marginBottom: '15px', marginTop: '10px' }}>How it works</h2>
          </div>
          <div className="row">
          ...
          <div className="row">
            <div className="col-lg-6 mx-auto wow fadeInDown" data-wow-duration="1s" data-wow-delay=".25s">
              <div className="site-heading text-center">
                <span className="site-title-tagline" style={{ fontWeight: 900, fontSize: '20px', color: '#fff' }}>Our Blog</span>
                <h2 className="site-title" style={{ fontWeight: 900, color: '#fff', fontSize: '64px' }}>Our Latest News & Blog</h2>
              </div>
            </div>
          </div>
          <div className="row">
