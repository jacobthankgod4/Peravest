-- Phase 1: Safe Atomic Ajo Schema Migration
-- Handles existing tables and adds new atomic structure

-- Drop existing basic ajo_savings table if it exists
DROP TABLE IF EXISTS ajo_savings CASCADE;
DROP TABLE IF EXISTS ajo_transactions CASCADE;

-- Create new atomic Ajo Groups table
...
-- Create atomic member management
...
-- Create member history tracking
