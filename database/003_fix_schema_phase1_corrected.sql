-- Peravest Database Schema Fixes - Phase 1 (Corrected)
-- Fixes: Removed duplicate CONSTRAINT definitions
...
-- 5. Fix Area data type from VARCHAR to NUMERIC
...
-- 8. Create investment_package table (FIXED: removed duplicate CONSTRAINT)
...
-- 9. Create investment table (FIXED: removed duplicate CONSTRAINT)
...
-- 10. Create property_image table (FIXED: removed duplicate CONSTRAINT)
...
-- End of Phase 1 migration (Corrected)
